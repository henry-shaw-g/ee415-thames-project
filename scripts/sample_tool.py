...
ImageInfo = namedtuple('ImageInfo', ['id', 'sliced_random', 'sliced_clump'])
...
if __name__ == '__main__':
    si = ImageIndex(r"test_image_index")
    si.save(build_structure=True)
    si.push_images([
        r"some_samples/bee-image-1.jpg",
        r"some_samples/bee-image-2.jpg",
        r"some_samples/bee-image-3.jpg",
        r"some_samples/bee-image-4.jpg",
    ])